...
async function renderQuoteDetail() {
  ...
  c.innerHTML = `
    <div class="main-header">
      ...
      <button class="btn btn-primary" onclick="shareWhatsAppPDF()" style="background:var(--green);border-color:var(--green);color:white;white-space:nowrap;padding:10px 16px;">📄 WhatsApp PDF</button>
